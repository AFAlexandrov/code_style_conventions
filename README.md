...
Из существующих конвенций наиболее комфортна для меня [Linux Kernel Coding Style](https://www.kernel.org/doc/html/latest/process/coding-style.html#codingstyle)
...
поэтому обоснование логики многих тезисов / разделов дано по ссылкам на источник.
...
* Оптимальная длина строки 80 символов.
	...
	поскольку так можно уместить два-три файла на одном экране.
...
поэтому можно использовать пробел, для отделения от имени функции.
